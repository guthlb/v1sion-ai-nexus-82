...
const Hero = () => {
  return (
    <section className="relative min-h-screen w-full bg-white overflow-hidden">
      ...
      {/* Initial Content - Only Main Title */}
      ...
      {/* Content After Video - Positioned Below */}
      <div className="relative z-10 bg-white mt-screen">
        <div className="max-w-5xl mx-auto px-4 py-16">
          <div className="text-center flex flex-col items-center">
            ...
            {/* Subheadline */}
            <p className="text-2xl md:text-3xl font-agile text-gray-900 mb-8 max-w-4xl mx-auto fade-in-up leading-relaxed" style={{animationDelay: '0.3s'}}>
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 h-32 bg-gradient-to-t from-amber-50 to-transparent opacity-50 pointer-events-none" />
    </section>
  );
};
