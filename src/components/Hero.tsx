    ...
    <section className="relative min-h-screen flex items-center justify-center bg-white overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="mb-8">
            <h1 className="text-7xl md:text-8xl lg:text-9xl font-mooxy font-black text-gray-900 leading-[0.85] tracking-tight fade-in-up">
              Strategic AI-Native
              <br />
          ...
          <div className="mb-16 fade-in-up" style={{animationDelay: '0.2s'}}>
            <p className="text-2xl md:text-3xl font-agile font-normal text-gray-600 tracking-wide">
              for the Enterprise
            </p>
          </div>
          
          {/* Supporting Line - Tertiary Hierarchy */}
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-24 fade-in-up" style={{animationDelay: '0.6s'}}>
            <button className="group inline-flex items-center justify-center gap-4 px-10 py-5 bg-gray-900 text-white font-semibold text-lg rounded-2xl transition-all duration-300 hover:bg-gray-800 hover:shadow-xl hover:-translate-y-1 min-w-[280px]">
              Schedule AI Readiness Assessment
              <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
            </button>
            
            <button className="inline-flex items-center justify-center px-10 py-5 bg-white text-gray-900 font-semibold text-lg rounded-2xl border-2 border-gray-200 transition-all duration-300 hover:bg-gray-50 hover:border-gray-300 hover:shadow-lg hover:-translate-y-1 min-w-[280px]">
              Book Strategic Consultation
            </button>
          </div>

          {/* Contact Information - Refined and Minimal */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-12 fade-in-up" style={{animationDelay: '0.8s'}}>
